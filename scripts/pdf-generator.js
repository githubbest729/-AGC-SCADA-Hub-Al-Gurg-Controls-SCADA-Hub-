...
window.AGC.PDF = (() => {
  ...
  function generateCostEstimationPdf(estimateData, totals) {
    ...
    // Create a real DOM element wrapper
    ...
    // Mount the container into the DOM so html2pdf can parse it as a valid element node
    ...
    // Pass the actual DOM element node into html2pdf().from()
